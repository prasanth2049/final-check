...
<body>
	<header> <span id="head">Movie Cruiser</span> <img class="img"
		src="./images/logo.png" /> <a id="movies" href="ShowFavorites">Favorites</a>
		...
		<table class="table">
			...
			<c:forEach items="${favorites}" var="movie">
				<tr>
					...
					<td class="title-gross"><fmt:formatNumber type="currency"
					...
					<td class="title-txt"><a
						href="RemoveFavorites?id=${movie.id }">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		<br> <b> No of Favorites:${fn:length(favorites)} </b>
